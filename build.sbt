...
host in upload := "nefarious-flare-snapshots.s3.amazonaws.com"

credentials += Credentials("Amazon S3", "nefarious-flare-snapshots.s3.amazonaws.com", System.getenv("ARTIFACTS_KEY"), System.getenv("ARTIFACTS_SECRET"))
